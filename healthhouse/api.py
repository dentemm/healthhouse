...
class CalendarItemAPIEndpoint(BaseAPIEndpoint):

  model = CalendarItem
  listing_default_fields = BaseAPIEndpoint.listing_default_fields + ['title', 'description', 'date']
  # body_fields = BaseAPIEndpoint.body_fields + ['title']
  meta_fields = BaseAPIEndpoint.meta_fields + ['title']
